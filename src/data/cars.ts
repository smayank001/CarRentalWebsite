...
export const cars: Car[] = [
  ...
  },
  {
    ...
    available: false,
    description:
      "The much-awaited Mahindra Scorpio-N is a powerful and spacious SUV, coming soon to our fleet...",
    features: [
      "Air Conditioning",
      "Manual Transmission",
      "Petrol Engine",
  ...
  },
  {
    ...
    available: true,
    description:
      "The Grand Vitara offers a commanding presence and a premium experience with its hybrid technology.",
    features: [
      "Panoramic Sunroof",
      "Ventilated Seats",
      "Wireless Charger",
  ...
  },
  {
    ...
    available: true,
    description:
      "A reliable and fuel-efficient hatchback, the 2016 Baleno model is a great choice for city driving.",
    features: [
      "Air Conditioning",
      "Manual Transmission",
      "Petrol Engine",
