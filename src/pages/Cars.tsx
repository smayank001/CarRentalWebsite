...
const Cars = () => {
  ...
  const filteredCars = cars.filter((car) => {
    ...
    const matchesPrice =
      priceRange === "all" ||
      (priceRange === "under2k" && car.price < 2199) ||
      (priceRange === "2kto5k" && car.price >= 2199 && car.price < 4999) ||
      (priceRange === "over5k" && car.price >= 4999);
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Explore our featured collection below. Our full inventory includes
              a wide variety of models to suit any need. Contact us for specific
              requests!
            </p>
            <Badge variant="secondary" className="mt-4 text-lg p-2">
              Cars Available For 12 Hours also
            </Badge>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <Select value={priceRange} onValueChange={setPriceRange}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="under2k">Under ₹2199</SelectItem>
                  <SelectItem value="2kto5k">₹2199 - ₹4999</SelectItem>
                  <SelectItem value="over5k">Over ₹4999</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <Carousel opts={{ align: "start" }} className="w-full">
            <CarouselContent className="-ml-4">
              {filteredCars.map((car) => (
                <CarouselItem
                  key={car.id}
                  className="pl-4 basis-11/12 sm:basis-1/2 lg:basis-1/3 xl:basis-1/4"
                >
                  <VehicleCard
                    vehicle={car}
