              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {" "}
                      The Manthan School Greater Noida West, GH 04, Plot No:,
                      16th Ave, Sector 16C, Gaur City 2, Greater Noida,
                      Ghaziabad, Uttar Pradesh 201318
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Aniket Motors</p>
                  </div>
                </div>
              </CardContent>
            </Card>
